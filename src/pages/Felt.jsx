...
import { gempaDirasakan } from "../data/data";
...
export default function Felt() {
  ...
  return (
    <section className="flex flex-col gap-3 font-jetbrains">
      <h1 className="sr-only">Daftar Gempa Dirasakan</h1>
      ...
      {dataGempa.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <dl className="grid grid-cols-2 gap-x-6 gap-y-2 text-xs w-full">
